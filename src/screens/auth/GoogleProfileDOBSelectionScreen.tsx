...
interface GoogleProfileDOBSelectionScreenProps {
  navigation: NativeStackNavigationProp<RootStackParamList, 'GoogleProfileDOBSelection'>;
  route: RouteProp<RootStackParamList, 'GoogleProfileDOBSelection'>;
}

const GoogleProfileDOBSelectionScreen = ({ navigation, route }: GoogleProfileDOBSelectionScreenProps) => {
  ...
  const handleContinue = () => {
    ...
    navigation.navigate('GoogleProfileGenderSelection', {
      fullName,
      username,
      dob: formatDOB(),
    });
...
export default GoogleProfileDOBSelectionScreen;
